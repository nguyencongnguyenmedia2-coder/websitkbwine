        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
          <div className="space-y-2">
            <span className="inline-flex items-center gap-1.5 text-gold text-xs font-semibold uppercase tracking-widest">
              <BookOpen className="w-3.5 h-3.5" /> Kiến Thức Rượu Vang
            </span>
            <h2 className="font-serif text-3xl sm:text-4xl text-gold-light font-bold">
              Góc Nhìn Cùng Sommelier Master
            </h2>
          </div>

          <Link
            href="/blog"
            className="inline-flex items-center gap-1 text-xs font-bold text-gold hover:text-gold-light transition-colors"
          >
